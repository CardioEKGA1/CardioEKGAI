...
// Dashboard display names drop the "AI" suffix — cleaner grid, consistent
// across card / recently-used pill / cases filters. The tool screens and
// marketing surfaces (landing, Stripe products, welcome email) retain the
// full "NephroAI" / "ClinicalNote AI" branding.
// Sorted alphabetically by display name.
const TOOLS: Tool[] = [
  { slug:'antibioticai', name:'Antibiotic',    icon:'🦠', desc:'IDSA-based antibiotic recommendations',                                                                                            monthly:9.99,  yearly:89.99,  keywords:'infectious disease antibiotics idsa uti cellulitis pneumonia cap hap sepsis bacteremia organism antibioticai' },
  { slug:'cerebralai',   name:'Cerebral',      icon:'🧠', desc:'Brain and spine MRI and CT interpretation',                                                                                        monthly:24.99, yearly:179.99, keywords:'brain spine mri ct neuroimaging stroke hemorrhage head radiology neurology cord cerebralai' },
  { slug:'clinicalnote', name:'ClinicalNote',  icon:'📝', desc:'AI that writes clinical notes in your voice — SOAP, H&P, discharge, consult, procedure — with style learning',                    monthly:24.99, yearly:179.99, keywords:'soap h&p note documentation discharge summary procedure consult hpi prior auth pa style learning voice personalized clinicalnote' },
  ...
  { slug:'nephroai',     name:'Nephro',        icon:'🫘', desc:'Comprehensive nephrology decision support',                                                                                        monthly:9.99,  yearly:89.99,  keywords:'aki ckd kdigo electrolytes sodium potassium calcium magnesium phosphorus acid-base abg dialysis transplant glomerulonephritis nephrotic hypertension htn kidney stones creatinine egfr nephrology nephroai' },
