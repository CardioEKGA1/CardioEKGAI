...
cat > ~/Desktop/CardioEKGAI/frontend/src/screens/Paywall.tsx << 'ENDOFFILE'
import React from 'react';
...
const Paywall: React.FC<Props> = ({ onBack }) => (
  <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',padding:'20px'}}>
    <div style={{background:'rgba(255,255,255,0.85)',borderRadius:'24px',padding:'40px',maxWidth:'480px',width:'100%',boxShadow:'0 8px 32px rgba(100,130,200,0.12)',textAlign:'center'}}>
      ...
      <div style={{fontSize:'14px',color:'#8aa0c0',marginBottom:'28px',lineHeight:'1.6'}}>You've used your 1 free EKG scan. Upgrade for unlimited AI-powered cardiac analysis.</div>
